...
@section('title','TokoLokal | Terms & Condition')
    ...
    <div class="container-xl my-5">
        ...
        <div class="spacing">
            ...
            <p class="silver">Unless otherwise noted all materials, including images, illustrations, designs, icons,
                ...
                license or with other legal authority by TokoLokal company. The site as a whole is protected by
                copyright and trade dress, titles, and interest in and to which are owned by TokoLokal company.</p>
        </div>
        ...
        <div class="spacing">
            ...
            <p class="silver">The information on the site may contain typographical errors or inaccuracies and may not
                ...
                you have submitted your order). Please note that such errors, inaccuracies or omissions may relate to
                product description, pricing, product availability, or otherwise.</p>
        </div>
        ...
        <div class="spacing">
            ...
            <p class="silver">If you purchase a product from us, we request certain personally identifiable
                ...
                information we collect from you to fill your orders and for billing purposes. We do not store your
                credit card information. If we have trouble processing an order, we will use this information to contact
                you.</p>
        </div>
        ...
        <div class="spacing">
            ...
            <p class="silver">We accept returns for SIZE EXCHANGE ONLY up to 10 business days for International Orders
                ...
                details on exchanging your item. Exchanged items will not be credited for shipping. Customers will be
                responsible for return shipping to TokoLokal. Once received, we will send out your exchange.

                If we send you a damaged or incorrectly shipped product please contact us immediately. Defective
                products or products you did not order but received from us will qualify for store credit. We reserve
                the right to refuse an exchange if the items have any signs of wear, misuse or damage.

                Customer is responsible for all shipping costs if TokoLokal is not at fault. If a different size is
                desired, TokoLokal will issue an exchange for the return in that item. However, we are not responsible
                for any shipping costs in the event of an exchange in size.

                Sale items are final and are not returnable.</p>
        </div>
        ...
        <div class="spacing">
            ...
            <div class="silver">
                ...
                <p></p>
                <p>MAILING ADDRESS</p>
                <p>Office 8, Level 18 – A</p>
                <p>Jl. Jend Sudirman Kav. 52-53</p>
                <p>Sudirman Central Business District (SCBD)</p>
                <p>Jakarta Selatan 12190</p>
                <p>Indonesia</p>
                <p>TOKO LOKAL HEADQUARTERS</p>
                <p>Jl. Bangka Raya No. 10 Unit C</p>
                <p>Jakarta Selatan 12720</p>
                <p>Indonesia</p>
            </div>
        </div>
