...
@section('title','TokoLokal | Men - Top')
			...
			<div class="row">
				...
				<div class="text-left">
					<form name="sortProducts" id="sortProducts">
						<input type="hidden" name="url" id="url" value="http://127.0.0.1:8000/men-tops">
		...
		<div class="col-sm-3">
			<div class="card border">
				<div class="bg-light border-bottom filter-header">
					<p class="mb-1 pt-2 px-2 font-weight-bold">Men Tops (<span class="countMen"></span>)</p>			
				</div>
