...
<div class="row">
    ...
    <div class="pro col-4">
        ...
        <a href="/product/detail/{{$p->id}}" style="width: 250px;height:270px;"><img src="{{asset('../storage/images/Products/' . $p->productimage)}}" width="250px;" height="270px;" alt="Image" class="card-img-top border"></a>
        </div>
