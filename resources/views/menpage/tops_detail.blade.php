...
<div class="container py-4">
    <div><p class="text-left">Home > {{$product_tops->category->name}} > {{$product_tops->productname}}</p></div>
</div>
    ...
    <div class="row">
        ...
        <div class="col-md-4 border border-dark">
            ...
            <div class="card-body mb-1" style="height:auto;"> 
                ...
                @guest
                <div class="row mb-3">
                    <a href="/login" class="card-link pt-2"><i class="far fa-heart" style="font-size: 22px;"></i></a>
                ...
                <form action="/wish-list/save" method="POST">
                    ...
                    <a type="submit" class="card-link pt-2 bg-white"><i class="far fa-heart" style="font-size: 22px;"></i></a>
                </form>
                <!--akhir wish list button -->
                <button class="btn btn-light border border-dark ml-3" style="width:300px; background-color:white;"><a href="#" class="card-link" style="color:black;">Add to Cart</a></button>
                </div>
                <div class="row">
