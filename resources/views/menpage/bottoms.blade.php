...
@section('title','TokoLokal | Men - Bottom')
...
<div class="container py-4">
	...
	<div class="col-md-12 mb-1 p-0">
		<div class="card rounded-0 border-0 con-photo w-100">
			<img src="{{ asset('../storage/images/Men Page/men-bottoms.jpg') }}" class="rounded-0 image-cat"
				alt="Men Display Picture" height="472px" style="object-fit: cover;">
			<div class="middle-cat">
				<div class="text-cat">BOTTOMS FOR MEN</div>
			</div>
		</div>
	</div>
		...
		<div class="col-sm-3">
			<div class="card border">
				<div class="bg-light border-bottom filter-header">
					<p class="mb-1 pt-2 px-2 font-weight-bold">Men Bottoms ({{$productscount}})</p>			
				</div>
