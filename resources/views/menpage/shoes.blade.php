...
@section('title','TokoLokal | Men - Shoe')
...
<div class="container py-4">
	...
	<div class="col-md-12 mb-1 p-0">
		<div class="card rounded-0 border-0 con-photo">
			<img src="{{ asset('../storage/images/Men Page/men-shoes.jpg') }}" class="rounded-0 image-cat"
				alt="Men Display Picture" width="1110px" height="472px" style="object-fit: cover;">
			<div class="middle-cat">
				<div class="text-cat">SHOES FOR MEN</div>
			</div>
		</div>
	</div>
			...
			<div class="row">
				...
				<div class="text-left">
					<form name="sortProducts" id="sortProducts">
						<input type="hidden" name="url" id="url" value="http://127.0.0.1:8000/men-shoes">
		...
		<div class="col-3">
			<div class="card border">
				<div class="bg-light border-bottom filter-header">
					<p class="mb-1 pt-2 px-2 font-weight-bold">Men Shoes (<span class="countMen"></span>)</p>			
				</div>
