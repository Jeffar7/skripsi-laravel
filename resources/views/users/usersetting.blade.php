                        ...
                        <div class="row gutters">
                            ...
                            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="eMail" placeholder="Enter email ID" value="{{$user->last_name}}" name="last_name">
                                </div>
                            </div>
                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-6 col-12">
                                <div class="form-group">
                                    <label for="fullName">Email</label>
                                    <input type="email" class="form-control" id="fullName" placeholder="Enter full name" value="{{$user->email}}" name="email">
                                </div>
                            </div>
                    ...
                    <div class="card-body">
                        <div class="row gutters">
                            ...
                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-6 col-12">
                                <div class="form-group">
                                    <label for="fullName">Email</label>
                                    <input type="email" class="form-control" id="fullName" placeholder="Enter full name" value="{{$user->email}}" name="email" disabled>
                                </div>
                            </div>
