...
@section('title','TokoLokal | Bottom')
			...
			<div class="row">
				...
				<div class="col-sm-3 text-left">
					<form name="sortProducts" id="sortProducts">
						<input type="hidden" name="url" id="url" value="{{ route('bottom') }}">
    ...
    <div class="row">
		<div class="col-3">
			<div class="card px-2 border border-dark" >
				<p class="mb-1 pt-2 font-weight-bold">Bottoms Product (<span class="countMen"></span>)</p>
