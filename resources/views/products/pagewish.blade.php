    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            <div class="search-group rounded left-addon-search inner-addon" style="width:100%;">
                ...
                <input type="search" class="search-field rounded" placeholder="Find your wishlist item"
                    aria-label="Search" aria-describedby="search-addon" style="width:100%;" />
            </div>
        </div>
...
<div class="container mb-5">
    <div class="card mt-4 px-3 mb-4"
        style="border-radius: 10px; box-shadow: 4px 4px 4px 4px #888888; width:100%; min-height:290px">
        <div class="row">
            <div class="col-sm-5">
                <div class="card-body">
            ...
            <div class="col-md-7 mb-2">
                <div class="card-body pt-4">
                    <div class="my-4">
                        <p class="about-title mb-0" style="text-decoration:normal;">
                            {{$productwish->product->brand->name}}</p>
                        <p class="pt-0" style="
                        font-size: 20px;
                    ">{{$productwish->product->productname}}</p>
                        <p style="font-weight:bold;font-size: 18px;" class="pt-1">Rp
                            {{number_format($productwish->product->productprice)}}</p>
                    </div>
                </div>
                <div class="row justify-content-center">
                    <div class="row col-md-2 text-right">
                        <a href="/wish-list/delete/{{$productwish->id}}" class="d-inline badge btn-danger"
                            data-value="{{$productwish->id}}"
                            style="height: 40px;width: 50px; border: 1px solid #e3342f;" data-toggle="modal"
                            data-target="#exampleModal{{$productwish->id}}"><i class="fas fa-trash-alt mt-2"
                    ...
                    <div class="col-md-10">
                        <form action="addtocart/{{$productwish->id}}" method="POST" class="d-inline">
                            ...
                            <button class="badge btn-success"
                                style="height: 40px;width: 100%;border: 1px solid #38c172;">
                                <p class="mt-2" style="
                            font-size: 16px;
                            color: white;
                        ">+ Add to Cart</p>
...
@foreach($productwishs as $productwish)
<div class="modal fade" id="exampleModal{{$productwish->id}}" tabindex="-1" aria-labelledby="exampleModalLabel"
    aria-hidden="true">
        ...
        <div class="modal-content" style="box-shadow: 4px 4px 4px 4px #575252;">
            <form action="/wish-list/delete/{{$productwish->id}}" method="POST" class="d-inline">
                ...
                <div class="modal-footer justify-content-around pt-0 border-top-0">
                    <button type="button" class="btn btn-secondary modalBtn border-0" data-dismiss="modal">Cancel</button>
