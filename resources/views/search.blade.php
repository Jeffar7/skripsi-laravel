        ...
        <div class="col-9">
            ...
            <div class="row">
                ...
                <div class="col-4">
                    ...
                    <a href="/men-tops/detail/{{$p->id}}" style="width: 250px;height:270px;"><img src="{{asset('../storage/images/Products/' . $p->productimage)}}" width="250px;" height="270px;" alt="Image" class="card-img-top border border-dark"></a>
                    </div>
                    <div class="card px-2 mb-4 border border-dark" style="width: 250px; border:none;">
                        <a href="/men-tops/detail/{{$p->id}}" style="color:black;"><p class="mt-3 mb-0 text-truncate" style="font-weight:bold;">{{$p->productname}}</p></a>
