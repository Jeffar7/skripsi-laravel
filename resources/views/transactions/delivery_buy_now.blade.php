                            ...
                            <option value="">Select Address</option>
                                @foreach($addresses as $address)
                                    <option id="address-{{$address->id}}" value="{{$address->id}}" 
                                        ...
                                        data-addressnote="{{$address->address_note}}"
                                        data-postcode="{{$address->post_code}}"
                                        data-province="{{$address->province}}"
                                        data-city="{{$address->city}}"
                                        data-district="{{$address->district}}">{{ $address->address }}</option>
                                @endforeach
                            </select>
                        </div>
                            ...
                            <select class="form-control" id="shipment_type" name="shipment" required>
                                <option value="">Select Shipment Type</option>
                                    @foreach($shipments as $shipment)
                                        ...
                                        data-shipestimated="{{$shipment->estimated_delivery}}">{{$shipment->shipment_method}}</option>
                                    @endforeach
                            </select>
                        </div>
                    </div>
