@extends('layouts.app') @section('title', 'TokoLokal | Delivery')
            ...
            <div class="col-md-12 text-center ">
                ...
                <div class="card" style="box-shadow: 4px 4px 4px 4px #888888;">
                    <div class="card-header text-left bg-dark text-white">
                        <img src="{{ asset('../storage/images/Transaction Page/addressLogo.png') }}" alt="" style="width: 2%;height: 20px;margin-top: -0.5%;">
                        <strong class="ml-2">
                            Address
                        </strong>
                    </div>
                    ...
                    <div class="row justify-content-center m-3">
                        <div class="col-sm-9">
                            <select class="form-control" id="address" name="address_detail" required>
                                ...
                                <option id="address-{{$address->id}}" value="{{$address->id}}" data-name="{{$address->recipient_name}}" data-contact="{{$address->contact_number}}" data-address="{{$address->address}}" data-addressnote="{{$address->address_note}}" data-postcode="{{$address->post_code}}" data-province="{{$address->province}}" data-city="{{$address->city}}" data-district="{{$address->district}}">
                                    {{ $address->address }}
                                </option>
                                @endforeach
                            </select>
                        ...
                        <div class="col-sm-3">
                            <div class="form-row">
                                <button type="button" class="btn btn-secondary" data-toggle="modal" data-target="#exampleModal" style="width:100%"><i class="fas fa-plus-circle"></i>
        ...
        <div class="row justify-content-center mb-3">
            <div class="col-md-12 text-center ">
                <div class="card mt-2" style="box-shadow: 4px 4px 4px 4px #888888;">
                    <div class="card-header text-left bg-dark text-white">
                        <img src="{{ asset('../storage/images/Transaction Page/shippingLogo2.png') }}" alt="" style="width: 2%;height: 20px;margin-top: -0.5%;">
                        <strong class="ml-2">
                            Shipping Option
                        </strong>
                    </div>
                    ...
                    <div class="row justify-content-center m-3">
                        <div class="col-sm-12">
                            <select class="form-control" id="shipment_type" name="shipment" required>
                                ...
                                <option id="shipment-{{$shipment->id}}" value="{{$shipment->id}}" data-shipmethod="{{$shipment->shipment_method}}" data-shipcost="{{$shipment->delivery_cost}}" data-shipestimated="{{$shipment->estimated_delivery}}">
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content card" style="border-radius: 10px; box-shadow: 1px 2px 10px 4px #575252;">
                <div class="modal-header card-header text-left bg-dark text-white">
                    ...
                    width: 250px;
                "> <img src="{{ asset('../storage/images/Transaction Page/addressLogo.png') }}" alt="" style="height: 20px;margin-top: -2.5%;margin-right: 4%;">Add Address</h5>
