                ...
                <div class="row justify-content-center mt-4 mb-3">
                    <div class="col-md-12 text-center ">
                        <div class="card mt-2" style="box-shadow: 4px 4px 4px 4px #888888;">
                            ...
                            <div class="row justify-content-center m-3">
                                <div class="col-sm-11" style="padding: 0">
                                    <select class="form-control" id="shipment_type" name="shipment"
                                        required>
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-12">
                                ...
                                <input wire:model="contact_number" type="text"
                                    ...
                                    id="contact_number" placeholder="Contact Number" name="contact_number">
                        ...
                        <div class="form-row mt-4">
                            ...
                            <div class="form-group col-md-8">
                                <button type="submit" class="btn btn-primary" name="formaddress"
                                    style="width: 100%">Save & Continue</button>
                            </div>
                        </div>
                    </div>
            </div>
