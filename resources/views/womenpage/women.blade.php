...
<div class="container py-4">
	...
	<div class="col-md-12 mb-1 p-0">
		<div class="card rounded-0 border-0 con-photo">
			<img src="../storage/images/Women Page/women-clothes.jpg" class="rounded-0 image-cat"
			...
			<div class="row">
				...
				<div class="text-left">
					<form name="sortProducts" id="sortProducts">
						<input type="hidden" name="url" id="url" value="http://127.0.0.1:8000/women">
		...
		<div class="col-3">
			<div class="card border">
				<div class="bg-light border-bottom filter-header">
					<p class="mb-1 pt-2 px-2 font-weight-bold">Women Products (<span class="countMen"></span>)</p>			
				</div>
				...
				<div class="bg-light border-bottom filter-header">
					<p class="my-2 px-2 font-weight-bold" data-toggle="collapse" href="#multiCollapseExample1" role="button" aria-expanded="false" aria-controls="multiCollapseExample1">
	...
	$(document).ready(function(){
		...
		$("#sort").on('change', function(){
			...
			$.ajax({
				url: url,
				method: 'POST',
				data: {sort:sort, category:category, brand:brand, size_alphabet:size_alphabet, size_number:size_number, min:min, max:max, url:url},
		...
		//filter category
		$(".category, .brand, .size_alphabet, .size_number").on('change', function(){
			var category = getIds("category[]");
			var brand = getIds("brand[]");
			var size_alphabet = getIds("size_alphabet[]");
			var size_number = getIds("size_number[]");
