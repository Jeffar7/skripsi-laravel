...
<div class="container py-4">
	...
	<div class="col-md-12 mb-1 p-0">
		<div class="card rounded-0 border-0 con-photo">
			<img src="{{ asset('../storage/images/Women Page/women-shoes.jpg') }}" class="rounded-0 image-cat"
				alt="Men Display Picture" width="1110px" height="472px" style="object-fit: cover;">
			<div class="middle-cat">
				<div class="text-cat">SHOES FOR WOMEN</div>
			</div>
		</div>
	</div>
		...
		<div class="col-3">
			<div class="card border">
				<div class="bg-light border-bottom filter-header">
					<p class="mb-1 pt-2 px-2 font-weight-bold">Women Shoes ({{$productscount}})</p>			
				</div>
