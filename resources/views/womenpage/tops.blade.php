...
@section('title','TokoLokal | Women - Top')
			...
			<div class="row">
				...
				<div class="col-sm-3 text-left">
					<form name="sortProducts" id="sortProducts">
						<input type="hidden" name="url" id="url" value="{{ route('women-tops') }}">
    ...
    <div class="row">
		<div class="col-3">
			<div class="card px-2 border border-dark" >
				<p class="mb-1 pt-2 font-weight-bold">Women's Top (<span class="countMen"></span>)</p>
...
<script>
	$(document).ready(function(){
		...
		$("#btnUncheckAll").on('click', function(){
			window.location='{{ route("women-tops") }}';
		});
	});
</script>
